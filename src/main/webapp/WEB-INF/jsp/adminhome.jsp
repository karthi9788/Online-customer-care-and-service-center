			...
			<table border="1" class="table table-striped table-responsive-md"
				...
				<thead>
					<tr>
						...
						<th class="data">Support Team</th>
						<th class="data">Status</th>
						<th class="data">Assign</th>
					...
					<c:forEach items="${complaintList }" var="complaint">
						<form:form action="/assignTeam/${complaint.complaintId }"
							...
							<tr>
								...
								<td class="data1"><form:select id="categoryName"
										path="categoryName" class="form-control mb-4 col-4">


										<c:forEach var="item" items="${complaintCategories }">
											<c:choose>
												<c:when test="${complaint.categoryName==item}">
								...
								<td class="data1"><form:select id="levelOfIssue"
										path="levelOfIssue" items="${levelAdmin}"
								...
								<td class="data1"><div class="add">
										<button id="add" class="btn btn-primary btn-sm mb-3">Assign</button>
									</div></td>
								<td class="data1"><div class="add">
										<a id="add" class="btn btn-primary btn-sm mb-3"
											href="/viewComplaint/${complaint.complaintId }">View</a>
									</div></td>
							</tr>
						</form:form>
					</c:forEach>
