...
<link rel="stylesheet" type="text/css" href="/CustomerCare/src/main/resources/static/css/viewComplaint.css">
<link rel="stylesheet"
			...
			<!--<form:form action="/assignTeam/${complaint.complaintId }"
				...
				<table border="1" class="table table-striped table-responsive-md" id="table">
					<tbody>
						...
						<tr><th class="data">User Id</th><td class="data1">${complaint.userId }</td></tr>
							<tr>
					...
					<tr>
						...
						<tr><th class="data">Complaint Category<td class="data1">${complaint.categoryName }</td></th></tr>
						<tr><th class="data">Complaint Statement</th><td class="data1">${complaint.complaintStatement }</td></tr>
						<tr><th class="data">Status</th><td class="data1">${complaint.status }</td></tr>
						
					</tbody>
				</table>
			<div class="add">
					<button id="add" onclick="exportData()" class="btn btn-primary btn-sm mb-3">Download</button>
				</div>
